 ...
 */
  ...
  /***
	 ...
	 * 
	 * @return List all entities of a kind from the cache or datastore (if not
	 *         in cache) in sorted order
	 */
public static Iterable<Entity> listSortedEntities(String kind, String sortBy) {
	logger.log(Level.INFO, "Search entities based on sort criteria");
	Query q = new Query(kind);
